...
export function SuperAdminHome() {
  return (
    <div className="flex flex-col items-center justify-center h-full min-h-[60vh] text-center px-6">
      ...
      <h1 className="text-2xl font-semibold text-slate-900 dark:text-zinc-100">Welcome, Dapplepot Admin</h1>
      <p className="mt-2 text-sm text-slate-500 max-w-sm dark:text-zinc-400">
