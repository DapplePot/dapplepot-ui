      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="border-b border-slate-100 dark:border-zinc-800">
            ...
            <th className="px-4 py-3 text-right text-xs font-medium text-slate-500 dark:text-zinc-400">LLM score</th>
            <th className="px-4 py-3 text-left text-xs font-medium text-slate-500 dark:text-zinc-400">LLM band</th>
            <th className="px-4 py-3 text-right text-xs font-medium text-slate-500 dark:text-zinc-400">ASI score</th>
            <th className="px-4 py-3 text-left text-xs font-medium text-slate-500 dark:text-zinc-400">ASI band</th>
            <th className="px-4 py-3 text-left text-xs font-medium text-slate-500 dark:text-zinc-400">Signals</th>
          </tr>
        </thead>
        <tbody className="divide-y divide-slate-50 dark:divide-zinc-800">
          {sessions.map((s) => (
            <tr
              ...
              className="cursor-pointer hover:bg-slate-50 transition-colors dark:hover:bg-zinc-800/50"
            >
              <td className="px-4 py-3 font-mono text-xs text-violet-600 dark:text-violet-400">
                {s.sessionId.slice(0, 8)}…
              </td>
              <td className="px-4 py-3 text-xs text-slate-600 dark:text-zinc-400">{agentMap[s.agentId] ?? s.agentId}</td>
