      ...
      <div className="flex shrink-0 items-center gap-2">
        ...
        {userRole === 'admin' && (
          <button
            ...
            className="flex items-center gap-1.5 rounded-md border border-slate-200 px-2.5 py-1.5 text-xs text-slate-500 hover:border-violet-300 hover:text-violet-600 disabled:opacity-40 dark:border-zinc-700 dark:text-zinc-400 dark:hover:border-violet-600 dark:hover:text-violet-400"
          >
