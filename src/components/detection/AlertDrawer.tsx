...
function SecurityDetail({ payload }: { payload: Record<string, unknown> }) {
  ...
  return (
    <div className="border-t border-slate-100 px-4 py-3 space-y-3 dark:border-zinc-800">
      ...
      {/* Attack chains */}
      {hasChains && (
        <div className="rounded border border-orange-200 bg-orange-50 px-3 py-2 dark:border-orange-800 dark:bg-orange-900/20">
...
export function AlertDrawer({ alert, onClose }: AlertDrawerProps) {
  ...
  return (
    <div className="rounded border border-slate-200 bg-white shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
      <div
        onClick={onClose}
