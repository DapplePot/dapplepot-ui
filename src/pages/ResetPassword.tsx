  ...
  return (
    <div className="flex min-h-screen bg-zinc-950 overflow-hidden">
      ...
      <div className="relative z-10 flex w-[380px] shrink-0 flex-col border-r border-zinc-800 bg-zinc-900 px-10 pt-14 pb-12 min-h-screen">
        ...
        <p className="mb-8 text-sm text-zinc-400">Set new password</p>
        <ResetPasswordForm />
      </div>
      ...
      <div className="relative flex-1 overflow-hidden bg-zinc-950">
        ...
        >
          <defs>
            <linearGradient id="rp-grad-right" x1="0%" y1="100%" x2="0%" y2="0%">
          ...
          <rect width="1000" height="1000" fill="url(#rp-grad-right)" clipPath="url(#rp-clip-right)" />
          ...
          <rect width="100%" height="100%" filter="url(#rp-grain)" opacity="0.16" />
        </svg>
